...
exports.findOne = (req, res) => {
    ...
    OtherIDs.findOne({
        ...
        .then(data => {
            if (!data)
                res.status(404).send({
                    message: "Not found Lecturer or Admin with name: " + Name
                });
            else
                res.send(data);
        })
        .catch(err => {
            res.status(500).send({
                message: "Error retriving Lecturer or Admin with name: " + Name
            });
        })
};
...
exports.update = (req, res) => {
    ...
    OtherIDs.findByNameAndUpdate(name, req.body, {
        ...
        .then(data => {
            if (!data) {
                ...
                res.send({
                    message: "Lecturer or Admin was updated successfully."
                });
        })
        .catch(err => {
            res.status(500).send({
